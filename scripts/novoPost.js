function adicionarPet(event) {
    ...
    if (nome && foto && descricao && tipo) {
        ...
        document.getElementById('form-pet').reset(); // Reseta o formulário

        window.location.href = 'listagemPostsAdmin.html';
    }
    
}

document
    .getElementById('form-pet') // Vai no documento e localiza o elemento com id 'form-pet'
    .addEventListener('submit', adicionarPet); // Adiciona um evento de submissão vinculado à função 'adicionarPet'